...
@endif
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="nip" id="nip" class="form-control p-input" placeholder="Nip....">
                    @if ($errors->has('nip'))
    <div class="alert alert-danger">
        {{ $errors->first('nip') }}
    </div>
...
@endif
                  ...
                  <div class="form-group">
                    <label for="tugas">Tugas</label>
                      <textarea name="tugas" id="tugas" class="form-control p-input" placeholder="Tugas...." rows="5"></textarea>
                      @if ($errors->has('tugas'))
    <div class="alert alert-danger">
        {{ $errors->first('tugas') }}
    </div>
