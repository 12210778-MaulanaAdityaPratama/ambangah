...
<footer id="footer" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="500">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h4>Kontak Kami</h4>
            <p>
              Jl.Karya Desa No. 45 Sungai Ambangah Sungai Raya Kubu Raya Kode Pos 78391<br><br>
              <strong>Phone:</strong> +62 89693226048<br>
              <strong>Email:</strong> ambangah@gmail.com<br>
            </p>
    ...
    <div class="container">
      ...
      <div class="credits">
        ...
        Designed by <a href="https://bootstrapmade.com/">S3rvantin</a>
      </div>
    </div>
  </footer><!-- End Footer -->
