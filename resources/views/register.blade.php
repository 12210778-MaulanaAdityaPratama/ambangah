            ...
            <div class="card-body px-5 py-5">
              ...
              <form>
                <div class="form-group">
                  <input type="text" class="form-control p_input" placeholder="Nama">
                </div>
                <div class="form-group">
                  <input type="number" class="form-control p_input" placeholder="NIK">
                </div>
                <div class="form-group">
                ...
                <p class="existing-user text-center pt-4 mb-0">Already have an acount?&nbsp;<a href="login">Sign up</a></p>
              </form>
            </div>
          </div>
        </div>
